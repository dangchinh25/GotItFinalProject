...
def test_create_category_successfully(client, access_token):
    generate_categories()
...
def test_create_category_fail_with_existed_name(client, access_token):
...
def test_create_category_fail_with_invalid_request_data(client, access_token):
...
def test_create_category_fail_with_missing_token(client):
