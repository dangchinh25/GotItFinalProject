...
def test_create_category_with_existed_name(client, credentials, category_name, status_code):
    response, json_response = create_category(client, credentials, category_name)
...
def test_create_category_with_invalid_request_data(client, credentials, category_name, status_code):
    response, json_response = create_category(client, credentials, category_name)
